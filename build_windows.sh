...
# Clone code from official Github repository
	rm -rf Master-3.0.0
	git clone https://github.com/MasterStakeCore/Master-3.0.0
...
# Create zip file of binaries
	cp Master-3.0.0/src/mastercored.exe Master-3.0.0/src/mastercore-cli.exe Master-3.0.0/src/mastercore-tx.exe Master-3.0.0/src/qt/mastercore-qt.exe .
	zip Windows.zip mastercored.exe mastercore-cli.exe mastercore-tx.exe mastercore-qt.exe
	rm -f mastercored.exe mastercore-cli.exe mastercore-tx.exe mastercore-qt.exe	
