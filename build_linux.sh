...
#Create zip file of binaries
	cp Master-3.0.0/src/mastercored Master-3.0.0/src/mastercore-cli Master-3.0.0/src/mastercore-tx Master-3.0.0/src/qt/mastercore-qt .
	zip Linux.zip mastercored mastercore-cli mastercore-tx mastercore-qt
	rm -f mastercored mastercore-cli mastercore-tx mastercore-qt   
